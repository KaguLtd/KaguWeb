...
export class ProgramsService {
  ...
  async workStart(assignmentId: string, dto: WorkSessionDto, actor: CurrentUserPayload) {
    if (actor.role !== "FIELD") {
  ...
  async workEnd(assignmentId: string, dto: WorkSessionDto, actor: CurrentUserPayload) {
    if (actor.role !== "FIELD") {
  ...
  async createLocationPing(assignmentId: string, dto: LocationPingDto, actor: CurrentUserPayload) {
    if (actor.role !== "FIELD") {
